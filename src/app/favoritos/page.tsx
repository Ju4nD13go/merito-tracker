  ...
  if (favVacancies.length === 0) {
    return (
      <div className="animate-in py-16 text-center fade-in">
        ...
        <Link
          href="/vacantes"
          className="btn-glow mt-6 inline-flex animate-in items-center gap-2 rounded-md px-4 py-2 text-sm font-medium text-primary-foreground fade-in [animation-delay:180ms]"
        >
          Explorar vacantes
        </Link>
      </div>
