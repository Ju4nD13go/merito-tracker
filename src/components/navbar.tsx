    ...
    <header className="sticky top-0 z-40 border-b bg-background/90 backdrop-blur">
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3">
        <Link href="/" className="group flex items-center gap-2 font-semibold">
          <span className="btn-glow inline-flex h-8 items-center rounded-md px-2 text-sm font-bold text-primary-foreground">
            MÉRITO
          </span>
              ...
              <li key={href}>
                <Link
                  ...
                  className={`relative flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm transition-all ${
                    active
                      ? "font-medium text-primary shadow-sm after:absolute after:-bottom-0.5 after:left-2 after:right-2 after:h-0.5 after:rounded-full after:bg-linear-to-r after:from-primary after:to-accent"
                      : "text-muted-foreground hover:-translate-y-0.5 hover:bg-muted hover:text-foreground hover:shadow-md active:translate-y-0 active:shadow-sm"
                  }`}
                >
